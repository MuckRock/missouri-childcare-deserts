...
This analysis and the numbers throughout are being fact-checked by external data, experts and colleagues. They aren't final numbers and will not be considered "final" until the article related to this reporting is published. If you find any errors or potential errors, please let Dillon Bergin (dillon@muckrock.com) know. 
:::
...
The number of programs bounced back sharply by six months later though, and since 2021, the number of children in childcare deserts has steadily moved towards where pre-pandemic numbers. 
