...
datawrapper_df <- supply_and_demand_2023 %>% 
  ...
  mutate(dw = case_when(is.na(pop_5_and_under) ~ paste("0 children and no childcare programs"), is.na(ratio) ~ paste(pop_5_and_under, "children and no childcare programs"), TRUE ~ paste("Child to slot ratio is", ratio, ":1")))
